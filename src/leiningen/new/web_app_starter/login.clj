...
(defpage "/login" {:as m}
  (shared/page {:main (do-> (substitute (login-form m))
...
(defpage "/signup" {:as m}
  (shared/page {:main (substitute (signup-form m))
                :sources []})) 
...
(defform-custom-post reset-password-form
